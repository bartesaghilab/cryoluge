...
def test_coords():
    ...
    with LexicalScope():
        ...
        assert_equal(coords.pivot(), Vec.D1(x=0))
    ...
    with LexicalScope():
        ...
        assert_equal(coords.pivot(), Vec.D2(x=0, y=2))
    ...
    with LexicalScope():
        ...
        assert_equal(coords.pivot(), Vec.D2(x=0, y=3))
        assert_equal(coords.fmin(), Vec.D2(x=-2, y=-2))
    ...
    with LexicalScope():
        ...
        assert_equal(coords.pivot(), Vec.D3(x=0, y=2, z=2))
    ...
    with LexicalScope():
        ...
        assert_equal(coords.pivot(), Vec.D3(x=0, y=2, z=3))
        assert_equal(coords.fmin(), Vec.D3(x=-2, y=-1, z=-2))
