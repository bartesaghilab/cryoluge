...
from cryoluge.io import ByteBuffer, BytesWriter, BinaryDataWriter, Endian
...
def test_write_scalars():
    ...
    writer.reset()
    data_writer.write_f64[Endian.Big](1.2345678987654321e16)
    assert_equal_buffers(buf.span(length=8), InlineArray[Byte, 8](
